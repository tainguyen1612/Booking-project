...
namespace QLKS.Areas.Admin.Controllers.Admin
{
    public class BillController : Controller
    {
        ...
        public ActionResult ConfirmCallService(String ma_hd, String ma_dv, String so_luong)
        {
        ...
        public ActionResult EditService(String ma_hd, String edit_id, String edit_so_luong)
        {
        ...
        public ActionResult DeleteService(String ma_hd, String del_id)
        {
        ...
        public ActionResult ConfirmPayment(String ma_hd, String tien_phong, String tien_dich_vu,String phu_thu, String tong_tien)
        {
        ...
        public ActionResult BillDetail(int? id)
        {
            ...
            return View("Details", tblHoaDon);
        }
        public ActionResult RoomRenewal(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult ResultRenewal(String ma_pdp,String ngay_ra)
        {
        ...
        public ActionResult ResultChangeRoom(String ma_pdp,String ma_phong_cu, String ma_phong_moi)
        {
            ...
            {
                tblPhieuDatPhong pdp = db.tblPhieuDatPhongs.Find(Int32.Parse(ma_pdp));
                tblPhong p = db.tblPhongs.Find(pdp.tblPhong.ma_phong);      // lấy thông tin cũ
