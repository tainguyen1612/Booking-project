...
namespace QLKS.Areas.Admin  .Controllers.Admin
{
    public class StatisticalController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.title_char1 = "Latest 15-day sales chart";
        ...
        public ActionResult Index(String start,String end)
        {
            ...
            ViewBag.title_char1 = "Sales from date chart "+start+" to "+ end;
            Char1(dateS, dateE);
            Char2(datenow);
            Char3();
            return View();
        ...
        private void Char1(DateTime start,DateTime end)
        {
            ...
            ViewBag.tong_tien = "Total revenue from date " + start.ToShortDateString() + " to " + end.ToShortDateString() + " là " + String.Format("{0:0,0.00}", tong) +" VND";
            ViewBag.C1sl = C1sl;
        ...
        private void Char3()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("ID Service: " + group.ten_dv + " | Quantity: " + group.total);
