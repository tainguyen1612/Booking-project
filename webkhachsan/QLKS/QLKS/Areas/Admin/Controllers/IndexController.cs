...
namespace QLKS.Areas.Admin.Controllers
{
    public class IndexController : Controller
    {
        ...
        public ActionResult ChooseToPickRoom()
        {
            return View();
        }
        public ActionResult ListRoomActive()
        {
        ...
        public ActionResult ListRoomCallService()
        {
            var list = db.tblHoaDons.Where(u => u.ma_tinh_trang == 1).Include(t => t.tblNhanVien).Include(t => t.tblPhieuDatPhong).Include(t => t.tblTinhTrangHoaDon);
            return View(list.ToList());
        }
        public ActionResult ReturnRoom(String id)
        {
            if (id == null)
            {
        ...
        public ActionResult FindHdById(int? id)
        {
            ...
            return RedirectToAction("Payment", "Bill", new { id = ma_hd });
        }
        ...
        public ActionResult CleanRoom(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Profile([Bind(Include = "ma_nv,ho_ten,ngay_sinh,dia_chi,sdt,tai_khoan,mat_khau,ma_chuc_vu")] tblNhanVien tblNhanVien)
        {
            if (ModelState.IsValid)
            {
