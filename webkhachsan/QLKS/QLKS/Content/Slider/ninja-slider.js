...
function NinjaSlider(a) {
    ...
    Y = "ontouchstart" in window || window.DocumentTouch && k instanceof DocumentTouch || v;
    var Eb = function () {
        if (Y) {
    ...
    var Wb = function (a) {
        ...
        qb = function (e, c, b) {
            if (!j.vR && (a.g == "auto" || f[d][L] == "50.1234%")) {
                b.rT = c / e * 100 + "%";
                f[d][L] == "50.1234%" && jb(b)
            }
        },
        ...
        Nb = function () {
            ...
            if (j.vR) j[d][F] = j.vR * k[O].clientHeight / 100 + "px"
        },
        Jb = function () {
    ...
    var ub = function (g) {
        ...
        tb = function (e, p) {
            ...
            if (p == 9) C(b[0], "sl-0");
                ...
                !p && o(b[e], "ns-show");
                var n = !h && j.offsetWidth == f[y].offsetWidth ? "2" : "",
                    g = e - c;
                if (!a.rewind) {
                    if (!e && c == r - 1) g = 1;
                    if (!c && e != 1 && e == r - 1) g = -1
    ...
    ub.prototype = {
        ...
        d: function () {
            if (a.g.indexOf(":") != -1) {
                ...
                if (b[1].indexOf("%") != -1) {
                    j.vR = parseInt(b[1]);
                    j[d][F] = j.vR * k[O].clientHeight / 100 + "px";
                    f[d][F] = f[y][d][F] = "100%";
                    return
                }
                var c = b[1] / b[0];
        ...
        addNavs: function () {
            ...
            var f = j.getElementsByClassName("fs-icon") || [];
            if (f[e]) {
                f = f[0];
                x(f, "click", function () {
                ...
                x(k, "keydown", function (a) {
                    a.keyCode == 27 && K(j, "fullscreen") && f.click()
                })
            }
        },
        sliderId: t,
