...
namespace QLKS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult PickRoom(string id)
        {
            //Session["ma_phong"] = id;
            try
            {
        ...
        public ActionResult CancelPickRoom(string id)
        {
            try
            {
                List<int> ds;
        ...
        private void AutoCancelBookingForm()
        {
        ...
        public ActionResult CancelBookingForm()
        {
            setNull();
            return RedirectToAction("BookRoom", "Home");
        }
